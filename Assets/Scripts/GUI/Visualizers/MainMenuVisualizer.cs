...
public class MainMenuVisualizer : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    /// <summary>
    /// Disables the gradient hover effect on the button text.
    /// </summary>
    ...
    /// <summary>
    /// Called when the pointer enters the button area. Enables the gradient hover effect.
    /// </summary>
    ...
    /// <summary>
    /// Called when the pointer exits the button area. Disables the gradient hover effect.
    /// </summary>
    /// <param name="eventData">The pointer event data.</param>
